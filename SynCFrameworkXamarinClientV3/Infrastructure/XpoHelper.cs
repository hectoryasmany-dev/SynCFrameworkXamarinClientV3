...
namespace SynCFrameworkXamarinClientV3.Infrastructure
{
    public static class XpoHelper
    {
        ...
        public static ApiFunction Function = new ApiFunction(client, "https://aff109f045bf.ngrok.io" + "/Sync", null);
        ...
        public static void InitXpoSync(string connectionString, string SyncUrl)
        {
            ...
            //var Identity = parser.GetPartByName(BIT.Xpo.Providers.OfflineDataSync.SyncDataStore.IdentityConst);
            //var DataConnectionString = parser.GetPartByName(BIT.Xpo.Providers.OfflineDataSync.SyncDataStore.DataConnectionStringConst);
            //var DeltaConnectionString = parser.GetPartByName(BIT.Xpo.Providers.OfflineDataSync.SyncDataStore.DeltaConnectionStringConst);
            //var EnableDeltaTrackingString = parser.GetPartByName(BIT.Xpo.Providers.OfflineDataSync.SyncDataStore.EnableDeltaTrackingConst);
            //var TablesToSkip = parser.GetPartByName(BIT.Xpo.Providers.OfflineDataSync.SyncDataStore.ExcludedEntitiesConst);
            //bool EnableDeltaTracking = true;
            //bool.TryParse(EnableDeltaTrackingString, out EnableDeltaTracking);
            ////objectsToDisposeOnDisconnect = new IDisposable[] { };


            //var syncadatstore= new SyncDataStoreAsynchronous(Identity, DataConnectionString, AutoCreateOption.DatabaseAndSchema, DeltaConnectionString, TablesToSkip, EnableDeltaTracking);
